 ...
 * @author javiiariass
 */
public class AutoAudi_Combustion extends AutoAbstracto_Audi {
    private int cilindrada;
    private String tipoCombustion; // Gasolina / Diesel / Hidrogeno

    public AutoAudi_Combustion(float precio, String modelo, String color, int potencia, float espacioMaletero, 
