 ...
 * @author javiiariass
 */
public class AutoMercedes_Combustion extends AutoAbstracto_Mercedes {

    private int cilindrada;
    private String tipoCombustion; // Gasolina / Diesel / Hidrogeno

    public AutoMercedes_Combustion(float precio, String modelo, String color, int potencia, float espacioMaletero,
