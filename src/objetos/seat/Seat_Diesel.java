 ...
 * @author javiiariass
 */
public class Seat_Diesel extends AutoAbstracto_Diesel implements I_AutoEuropeo{
    
    private float subvencion;
    
    
    
    public Seat_Diesel(String fabricante, String modelo, String color, int potencia, float espacioMaletero, 
        ...
        this.subvencion = 209; // valor por defecto para seat diesel
    }
