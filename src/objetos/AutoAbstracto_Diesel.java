 ...
 * @author javiiariass
 */
public abstract class AutoAbstracto_Diesel extends AutoAbstracto{

    protected int cilindrada;

    public AutoAbstracto_Diesel(String fabricante, String modelo, String color, int potencia, float espacioMaletero,
