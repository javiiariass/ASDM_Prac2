 ...
 * @author javiiariass
 */
public class AutoSeat_Combustion extends AutoAbstracto_Seat {
    private int cilindrada;
    private String tipoCombustion; // Gasolina / Diesel / Hidrogeno

    public AutoSeat_Combustion(float precio, String modelo, String color, int potencia, float espacioMaletero, 
