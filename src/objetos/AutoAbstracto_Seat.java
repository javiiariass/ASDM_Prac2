 ...
 * @author javiiariass
 */
public abstract class AutoAbstracto_Seat extends AutoAbstracto {
    protected float subvecion;

    public AutoAbstracto_Seat(float precio, String modelo, String color, int potencia, float espacioMaletero, 
