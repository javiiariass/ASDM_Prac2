 ...
 * @author javiiariass
 */
public class Mercedes_Electrico extends AutoAbstracto_Electrico implements I_AutoEuropeo{
     ...
     * @param precio 
     */
    public Mercedes_Electrico(String fabricante, String modelo, String color, int potencia, float espacioMaletero, 
        ...
        this.subvencion = 300; // valor por defecto para mercedes electricos
    }
