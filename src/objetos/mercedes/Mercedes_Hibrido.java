 ...
 * @author javiiariass
 */
public class Mercedes_Hibrido extends AutoAbstracto_Hibrido implements I_AutoEuropeo{
     ...
     * @param precio 
     */
    public Mercedes_Hibrido(String fabricante, String modelo, String color, int potencia, float espacioMaletero, 
        ...
        this.subvencion = 400; // valor por defecto para mercedes hibridos
    }
