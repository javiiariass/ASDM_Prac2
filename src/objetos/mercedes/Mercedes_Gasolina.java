 ...
 * @author javiiariass
 */
public class Mercedes_Gasolina extends AutoAbstracto_Gasolina implements I_AutoEuropeo{
     ...
     * @param precio 
     */
    public Mercedes_Gasolina(String fabricante, String modelo, String color, int potencia, float espacioMaletero, 
        ...
        this.subvencion = 209; // valor por defecto para mercedes gasolina
    }
