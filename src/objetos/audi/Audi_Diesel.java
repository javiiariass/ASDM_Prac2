 ...
 * @author javiiariass
 */
public class Audi_Diesel extends AutoAbstracto_Diesel implements I_AutoEuropeo{
     ...
     * @param precio 
     */
    public Audi_Diesel(String fabricante, String modelo, String color, int potencia, float espacioMaletero, 
        ...
        this.subvencion = 0; // valor por defecto para audis diesel
    }
